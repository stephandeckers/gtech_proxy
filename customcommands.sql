...
delete from G3E_CUSTOMCOMMAND where g3e_username = 'Swap Inner-ducts';
insert into G3E_CUSTOMCOMMAND ( G3E_CCNO, G3E_USERNAME, G3E_DESCRIPTION, G3E_AUTHOR, G3E_COMMENTS, G3E_LARGEBITMAP, G3E_SMALLBITMAP, G3E_TOOLTIP, G3E_STATUSBARTEXT, G3E_COMMANDCLASS, G3E_ENABLINGMASK, G3E_MODALITY, G3E_SELECTSETENABLINGMASK, G3E_MENUORDINAL, G3E_LOCALECOMMENT, G3E_INTERFACE)
values (G3E_CUSTOMCOMMAND_SEQ.Nextval, 'Swap Inner-ductsn','Swap Inner-ducts','Stephan Deckers','For use in production',0,0,'Swap Inner-ducts', null, 4, 8388624, 0, 0, 1, null, 'Proximus.ifh.SwapInnerDucts:Proximus.ifh.SwapInnerDucts.SwapInnerDuctsController');
